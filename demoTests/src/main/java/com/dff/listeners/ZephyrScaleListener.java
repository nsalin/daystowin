...
import com.dff.container.CustomExecutionContainer;
import com.dff.container.CustomExecutionException;
import com.dff.container.CustomSuiteContainer;
import com.dff.container.CustomTestContainer;
import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.ind.dw.zephyr.annotation.ZephyrTestCase;
import com.ind.dw.zephyr.client.ZephyrScaleClient;
import com.ind.dw.zephyr.client.ZephyrScaleClientFactory;
import com.ind.dw.zephyr.client.model.ExecutionStatus;
import com.ind.dw.zephyr.client.request.CreateTestCaseRequest;
import com.ind.dw.zephyr.client.request.CreateTestExecutionRequest;
...
public class ZephyrScaleListener implements ISuiteListener, ITestListener {
    ...
    private enum AnnotationType {
        TestCase(com.ind.dw.zephyr.annotation.ZephyrTestCase.class.getCanonicalName()),
    ...
    private void initSuiteContainer(String projectKey, String suiteName) {
        if (projectKey != null && !projectKey.equals("")) {
            ...
            Optional<CreateTestCaseRequest> testRun = zephyrScaleClient.getTestCycleByProjectKeyAndName(projectKey, suiteName);
            String testCycleKey;
            if (testRun.isPresent()) {
                ...
                CreateTestCaseRequest newTestCycle = zephyrScaleClient.createTestCycle(suiteContainer.getProjectKey(), suiteContainer.getName());
    ...
    private String calculateTestCaseKey(ITestResult testResult) {
        ...
        if (annotation.isPresent()) {
            switch (AnnotationType.getAnnotationType(annotation.get())) {
                case TestCase:
                    testCaseKey = ((ZephyrTestCase) annotation.get()).value();
                    break;
                case TmsLink:
