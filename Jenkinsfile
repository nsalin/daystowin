pipeline {
    ...
    post {
        always {
            ...
            publishTestResults autoCreateTestCases: true, filePath: 'target/surefire-reports/junitreports/*.xml', format: 'JUnit XML Result File', projectKey: 'IND', serverAddress: 'https://innovationdays.atlassian.net'
            }
        }
}
